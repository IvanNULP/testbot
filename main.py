...
MODES = {    
    ...
    "poder": "Лесь Подервʼянський-стайл: пафос, матюки, інтелектуальна сатира, гротеск і театр, відомі вислови Леся Подервʼянського. "
}
...
async def determine_best_mode(user_text: str, history: str, replied_text: str) -> str:
    ...
    mode_prompt = (
        ...
        "zel_bot, balashov, vorchun, poder. Враховуй суть повідомлення, його пафос, тон, стиль. І обов'язково використай стиль троллінгу щоб відповідь стосувалась саме троллінгу. "
...
"Відповідай як контраргумент, будь інколи але не завжди цінічним. "
        ...
        "Звертайся на 'ти' або на 'ви' якщо выд цього буде смішніше і воно пасує в контексті. Можеш пробувати щось пояснити але не виправдовуйся надмірно. "
        "Відповідь має бути не велика. Максимум на 2 речення "
        f"Контекст: {history}\n"
        f"Якщо це відповідь на інше повідомлення: {replied_text}\n"
