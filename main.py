...
async def determine_best_mode(user_text: str, history: str, replied_text: str) -> str:
    ...
    mode_prompt = (
        ...
        "zel_bot, balashov, vorchun, poder. Враховуй суть повідомлення, його пафос, тон, стиль. І обов'язково використай стиль троллінгу щоб відповідь стосувалась його. "
...
async def generate_reply(user_text: str, selected_mode: str, replied_text: str, history: str) -> str:
    prompt = (
        ...
        "Твоє завдання — троллінг-відповідь самозакоханому всезнайку, який впевнений, що знає все краще за всіх, диванному експерту. "
"Не використовуй слово самозакоханий і всезнайко і їх синоніми проте перевіряй текст на грамматичні і стилістичні помилки. "
"Відповідай як контраргумент,будь цінічним. "
