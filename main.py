...
MODES = {    
    ...
    "rashn_tv": "Пропагандист із рашн тб  — пафосно бреше про зовнішні загрози, вихваляє перемоги навіть із поразок, постійно кричить про ворогів і героїзм наших людей, перекручує будь-які факти на користь своїх. Слова перемога, вороги, героїзм, своїх — це все в лапках, тобто перекручені факти. "
}
...
async def determine_best_mode(user_text: str, history: str, replied_text: str) -> str:
    ...
    mode_prompt = (
        ...
        "Враховуй суть повідомлення, його пафос, тон, стиль. І обов'язково використай стиль троллінгу щоб відповідь стосувалась саме троллінгу. "
...
"Відповідай як контраргумент, будь інколи але не завжди цінічним. "
        "Твоя відповідь інколи може бути жорсткою але завжди з іронією, сатирою, можливо сарказмом, вмикай фантазію, роздумуй якщо треба, веди себе як людина яка відповідає такому опоненту, щоб пожартувати. "
        "Звертайся на 'ти' або на 'ви' якщо від цього буде смішніше і воно пасує в контексті. Можеш пробувати щось пояснити але не виправдовуйся надмірно. Дозволяю використовувати матюки, матерні слова, українську лайку. Також можеш інколи звертатись до автора за іменем- Михайло, Місько, Михуїл, Міша та інші подібні похідні імена. "
        "Відповідь має бути не велика. Максимум на 2 речення. Якщо треба можеш використати смайлики або гіфку. "
        f"Контекст: {history}\n"
        f"Якщо це відповідь на інше повідомлення: {replied_text}\n"
