...
async def generate_reply(user_text: str, mode: str, replied_text: str = "", history: str = "") -> str:
    ...
    prompt = (
        ...
        "Формулюй відповідь грамотно, синтаксично і стилістично правильно, з урахуванням норм сучасної української мови. "
        "Не допускай граматичних або логічних помилок навіть у саркастичних відповідях. "
        "Слідкуй, щоб речення було завершеним, з логічною структурою та крапкою в кінці.\n\n"
