...
async def generate_reply(user_text: str, selected_mode: str, replied_text: str, history: str, is_target_user: bool) -> str:
    prompt = (
        ...
        f"{'Також можеш інколи, але не завжди, звертатись до автора за іменем- Зідан, Зіданга, Зіданус, Зідаун, Михайло, Місько, Михуїл, Міша та інші подібні похідні імена. Зіданга використовуй коли автор говорить про майбутнє як Ванга.' if is_target_user else ''} "
...
async def handle_all(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        reply = await generate_reply(user_text, selected_mode, replied_text, history, is_target_user)
